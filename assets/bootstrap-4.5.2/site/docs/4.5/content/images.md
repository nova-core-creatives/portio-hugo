...
{% highlight html %}
<img loading="lazy" src="..." class="img-fluid" alt="Responsive image">
{% endhighlight %}
...
{% highlight html %}
<img loading="lazy" src="..." alt="..." class="img-thumbnail">
{% endhighlight %}
...
{% highlight html %}
<img loading="lazy" src="..." class="rounded float-left" alt="...">
<img loading="lazy" src="..." class="rounded float-right" alt="...">
{% endhighlight %}
...
{% highlight html %}
<img loading="lazy" src="..." class="rounded mx-auto d-block" alt="...">
{% endhighlight %}
...
If you are using the `<picture>` element to specify multiple `<source>` elements for a specific `<img loading="lazy">`, make sure to add the `.img-*` classes to the `<img loading="lazy">` and not to the `<picture>` tag.

{% highlight html %}
​<picture>
  <source srcset="..." type="image/svg+xml">
  <img loading="lazy" src="..." class="img-fluid img-thumbnail" alt="...">
</picture>
{% endhighlight %}
